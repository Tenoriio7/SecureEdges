...
<%@page import="br.com.secureedges.core.web.bean.GraficoBean"%>
...
<%
	GraficoBean bean = new GraficoBean();
	RelatorioSolicitacao solicitacao = (RelatorioSolicitacao) bean.relatorios;
